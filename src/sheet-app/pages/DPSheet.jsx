...
function DPSheet({ auth, setAuth }) {
  ...
  const API_URL = 'http://Dsa-backend-env.eba-mxqqpgkr.ap-south-1.elasticbeanstalk.com/api/dp-questions';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-4">
              <Link to="/sheet" className="text-[#ffd700] hover:text-[#ffd700]/80 transition-colors">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 19l-7-7m0 0l7-7m-7 7h18" />
                </svg>
              </Link>
              <h1 className="text-2xl font-bold">
                <span className="text-[#ffd700]">Dynamic Programming</span> Sheet
              </h1>
            </div>
            <div className="flex items-center space-x-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            ...
            <div className="bg-[#1a1a1a] p-4 rounded-lg border border-[#2a2a2a]">
              ...
              <div className="text-2xl font-bold text-[#ffd700]">{completedCount}</div>
            </div>
            <div className="bg-[#1a1a1a] p-4 rounded-lg border border-[#2a2a2a]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="relative">
          <input
            ...
            className="w-full bg-[#1a1a1a] border border-[#2a2a2a] rounded-lg px-4 py-3 pl-12 text-white placeholder-gray-500 focus:outline-none focus:border-[#ffd700] transition-colors"
          />
          <svg
                ...
                {difficultyQuestions.map((question, index) => (
                  <div
                    ...
                    className={`bg-[#1a1a1a] border rounded-lg p-4 hover:bg-[#252525] transition-all ${
                      question.completed ? 'border-[#ffd700]/50' : 'border-[#2a2a2a]'
                    }`}
                  >

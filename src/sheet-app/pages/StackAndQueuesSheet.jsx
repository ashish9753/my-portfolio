...
function StackAndQueuesSheet({ auth, setAuth }) {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center">
        <div className="text-[#00ff00] text-xl">Loading Stack and Queues questions...</div>
      </div>
    );
  }
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-2xl font-bold">
                <span className="text-[#f97316]">Stack and Queues</span> Sheet
              </h1>
            </div>
            <div className="flex items-center space-x-4">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="relative">
          <input
            ...
            className="w-full bg-[#1a1a1a] border border-[#2a2a2a] rounded-lg px-4 py-3 pl-12 text-white placeholder-gray-500 focus:outline-none focus:border-[#f97316] transition-colors"
          />
          <svg
                  ...
                  {difficultyQuestions.map((question, index) => (
                    <div
                      ...
                      className={`bg-[#1a1a1a] border rounded-lg p-4 hover:bg-[#252525] transition-all ${
                        question.completed ? 'border-[#f97316]/50' : 'border-[#2a2a2a]'
                      }`}
                    >
                      <div className="flex items-start space-x-4">
                        <input
                          ...
                          className="mt-1 w-5 h-5 rounded border-gray-600 text-[#f97316] focus:ring-[#f97316] focus:ring-offset-0 cursor-pointer"
                        />
...
export default StackAndQueuesSheet;

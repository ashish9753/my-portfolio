...
function RecursionSheet({ auth, setAuth }) {
  ...
  const API_URL = 'http://13.201.54.180:5000/api/recursion-questions';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-4">
              <Link to="/sheet" className="text-[#fb7185] hover:text-[#fb7185]/80 transition-colors">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 19l-7-7m0 0l7-7m-7 7h18" />
                </svg>
              </Link>
              <h1 className="text-2xl font-bold">
                <span className="text-[#fb7185]">Recursion</span> Sheet
              </h1>
            </div>
            <div className="flex items-center space-x-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            ...
            <div className="bg-[#1a1a1a] p-4 rounded-lg border border-[#2a2a2a]">
              ...
              <div className="text-2xl font-bold text-[#fb7185]">{completedCount}</div>
            </div>
            <div className="bg-[#1a1a1a] p-4 rounded-lg border border-[#2a2a2a]">
          ...
          <div className="mt-4">
            ...
            <div className="w-full bg-[#2a2a2a] rounded-full h-2">
              <div
                className="bg-[#fb7185] h-2 rounded-full transition-all duration-300"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="relative">
          <input
            ...
            className="w-full bg-[#1a1a1a] border border-[#2a2a2a] rounded-lg px-4 py-3 pl-12 text-white placeholder-gray-500 focus:outline-none focus:border-[#fb7185] transition-colors"
          />
          <svg
                  ...
                  {difficultyQuestions.map((question, index) => (
                    <div
                      ...
                      className={`bg-[#1a1a1a] border rounded-lg p-4 hover:bg-[#252525] transition-all ${
                        question.completed ? 'border-[#fb7185]/50' : 'border-[#2a2a2a]'
                      }`}
                    >
                      <div className="flex items-start space-x-4">
                        <input
                          ...
                          className="mt-1 w-5 h-5 rounded border-gray-600 text-[#fb7185] focus:ring-[#fb7185] focus:ring-offset-0 cursor-pointer"
                        />

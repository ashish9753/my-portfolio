...
function BinaryTreesSheet({ auth, setAuth }) {
  const topic = 'Binary Trees'; // Hardcoded for Binary Trees page
  ...
  if (loading) {
    return <LoadingScreen message="Loading Binary Trees questions..." />;
  }
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-2xl font-bold">
                <span className="text-[#00ff00]">Binary Trees</span> Sheet
              </h1>
            </div>
            <div className="flex items-center space-x-4">
...
export default BinaryTreesSheet;

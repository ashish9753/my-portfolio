						...
						<div className="border border-[#2a2a2a] rounded-xl overflow-hidden">
							...
							>
								...
								<div className="flex items-center gap-3">
									<span className="text-xs text-gray-600 bg-[#1a1a1a] px-3 py-1 rounded-full border border-[#2a2a2a]">{totalOSQuestions}Q</span>
									<a
										href="https://youtu.be/e01GGTKmtpc?si=vtt61vR0AO7gR7oT"
										target="_blank"
										rel="noopener noreferrer"
										title="Watch Linux on YouTube"
										className="text-red-500 hover:text-red-400 hover:scale-125 transition-all duration-300"
													...
													return (
														...
														>
															<div className="flex items-center gap-1">
																...
																{/* ChatGPT icon */}
																<a
																	href={`https://chatgpt.com/?q=${encodeURIComponent(`${item.q} in Linux/DevOps, explain in short.`)}`}
																	target="_blank"
																	rel="noopener noreferrer"
																	title="Ask ChatGPT"
																...
																{/* YouTube icon */}
																<a
																	href={item.yt || `https://www.youtube.com/results?search_query=${encodeURIComponent(`${item.q} Linux explained`)}`}
																	target="_blank"
																	rel="noopener noreferrer"
